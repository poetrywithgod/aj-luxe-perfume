...
export function LinkedinIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M6.94 8.5H3.56V20h3.38V8.5ZM5.25 3.25a1.97 1.97 0 1 0 0 3.94 1.97 1.97 0 0 0 0-3.94ZM20.44 20h-3.37v-6.24c0-1.5-.03-3.42-2.08-3.42-2.09 0-2.41 1.63-2.41 3.31V20H9.2V8.5h3.24v1.57h.05c.45-.86 1.56-1.77 3.21-1.77 3.43 0 4.06 2.26 4.06 5.2V20Z" />
    </svg>
  );
}
